...
async function kickCommand(sock, chatId, senderId, mentionedJids, message) {
    ...
    if (!isOwner) {
        ...
        if (!isSenderAdmin) {
            await sock.sendMessage(chatId, { text: ' Izah Only group admins can use the kick command.' }, { quoted: message });
            return;
        }
    }
    ...
    try {
        ...
        await sock.sendMessage(chatId, { 
            text: `${usernames.join(', ')} has 🦠 been kicked successfully kindly follow the group rules to avoid this!`,
